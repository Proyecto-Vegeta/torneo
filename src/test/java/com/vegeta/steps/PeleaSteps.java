...
public class PeleaSteps {
    ...
    public void PresentarLuchadores(int Luchador1_tipo, int Luchador1_fuerza, int Luchador1_resistencia, int Luchador1_destreza, int Luchador1_puntuacion, int Luchador2_tipo, int Luchador2_fuerza, int Luchador2_resistencia, int Luchador2_destreza, int Luchador2_puntuacion) {
        if (Luchador1_tipo==1) {
